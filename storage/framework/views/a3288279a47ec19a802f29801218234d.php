...
<?php $__currentLoopData = $academia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $academy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="offcanvas offcanvas-end w-50" tabindex="-1" id="tasksDetailsOffcanvasEdit<?php echo e($academy->id); ?>">
        <div class="offcanvas-header border-bottom" style="padding-top: 20px; padding-bottom: 20px">
            <div class="d-flex align-items-center">
                ...
                <a href="javascript:void(0);">
                    <h2 class="fs-14 fw-bold text-truncate-1-line">Journal</h2>
        ...
        <div class="offcanvas-body">
            <form action="<?php echo e(route('journal.update', $academy->id)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" name="e_issn" value="<?php echo e(old('name_kr',$academy->e_issn)); ?>" class="form-control">
                        </div>
                        <div class="form-group mb-4">
...
<?php /**PATH C:\Users\user\Desktop\kriminologiya sayt\Kriminalogiya.tar\Kriminalogiya\resources\views/components/admin/jurnal/jurnal-modal-edit.blade.php ENDPATH**/ ?>