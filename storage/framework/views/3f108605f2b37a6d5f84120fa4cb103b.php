...
<div class="home-luxury">
    ...
    <section class="lx-hero">
        <div class="owl-carousel header-carousel">
            <?php $__currentLoopData = ['1.6.png','1.2.png','1.4.png','1.3.png','1.1.png','1.5.png']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="lx-hero-slide" style="background-image: url('<?php echo e(asset('img/'.$img)); ?>');"></div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>

        <div class="lx-hero-content">
            <div class="lx-hero-divider">
                <span><?php echo e(__('lan.kriminalog')); ?></span>
            </div>
            ...
            <h1 class="lx-hero-title">
                ...
                <br>
                <em><?php echo e(__('lan.ins_haq')); ?></em>
            </h1>

            <p class="lx-hero-sub">
                <?php if(!empty($contact?->address)): ?> <?php echo e($contact->address); ?> <?php endif; ?>
            </p>

            <div class="lx-hero-cta">
                <a href="<?php echo e(route('boss')); ?>" class="lx-btn">
                    <span><?php echo e(__('lan.batafsil')); ?></span>
    ...
    <section class="lx-section" style="background: var(--lx-cream);">
        <div class="container">
            ...
            <div class="lx-section-head" data-aos="fade-up">
                ...
                <h2 class="lx-section-title"><?php echo e(__('lan.yangilik')); ?></h2>
            </div>
            ...
            <?php $__currentLoopData = $newsBlocks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $block): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($block['items']->count()): ?>
                <div class="lx-news-block" data-aos="fade-up">
                    <div class="lx-news-block-head">
                        <h3><?php echo e($block['title']); ?></h3>
                        <a class="lx-news-link" href="<?php echo e(route('categoryId', $block['cat_id'])); ?>">
                            <?php echo e(__('lan.batafsil')); ?> &rarr;
                        </a>
                    </div>
                    <div class="lx-news-grid">
                        <?php $__currentLoopData = $block['items']->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $new): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('show', ['category_id' => $block['cat_id'], 'id' => $new->id])); ?>"
                               class="lx-news-card"
                               data-aos="fade-up" data-aos-delay="<?php echo e($i * 100); ?>">
                                <div class="lx-news-thumb">
                                    ...
                                    <?php if($new->photos->first()): ?>
                                        <img src="<?php echo e(asset('storage/'.$new->photos->first()->file_path)); ?>"
                                             alt="<?php echo e($new->name); ?>"
                                             loading="lazy"
                                ...
                                <div class="lx-news-body">
                                    <div class="lx-news-meta">
                                        <span><?php echo e($new->created_at?->format('d.m.Y')); ?></span>
                                    </div>
                                    <h4 class="lx-news-title"><?php echo e($new->name); ?></h4>
    ...
    <section class="lx-section charcoal">
        <div class="container">
            <div class="lx-section-head" data-aos="fade-up">
                ...
                <h2 class="lx-section-title"><?php echo e(__('lan.malumot')); ?></h2>
            </div>

            <div class="lx-categories-grid">
                <a href="<?php echo e(route('categoryId', 13)); ?>" class="lx-category-card" data-aos="fade-up" data-aos-delay="0">
                    <div class="lx-category-thumb">
                        <img src="<?php echo e(asset('assets/img/i2.jfif')); ?>" alt="" loading="lazy">
                    </div>
                    <div class="lx-category-body">
                        <div class="lx-category-num">01</div>
                        <h3 class="lx-category-title"><?php echo e(__('lan.ijti_ama_tad')); ?></h3>
                    </div>
                    <div class="lx-category-arrow">&rarr;</div>
                </a>

                <a href="<?php echo e(route('categoryId', 15)); ?>" class="lx-category-card" data-aos="fade-up" data-aos-delay="100">
                    <div class="lx-category-thumb">
                        <img src="<?php echo e(asset('assets/img/i3.jfif')); ?>" alt="" loading="lazy">
                    </div>
                    <div class="lx-category-body">
                        <div class="lx-category-num">02</div>
                        <h3 class="lx-category-title"><?php echo e(__('lan.kitobxonlik')); ?></h3>
                    </div>
                    <div class="lx-category-arrow">&rarr;</div>
                </a>

                <a href="<?php echo e(route('show', ['category_id' => 18, 'id' => 5])); ?>" class="lx-category-card" data-aos="fade-up" data-aos-delay="200">
                    <div class="lx-category-thumb">
                        <img src="<?php echo e(asset('assets/img/i4.jfif')); ?>" alt="" loading="lazy">
                    </div>
                    <div class="lx-category-body">
                        <div class="lx-category-num">03</div>
                        <h3 class="lx-category-title"><?php echo e(__('lan.jin_va_jin_saq')); ?></h3>
                    </div>
                    <div class="lx-category-arrow">&rarr;</div>
                </a>

                <a href="<?php echo e(route('categoryId', 33)); ?>" class="lx-category-card" data-aos="fade-up" data-aos-delay="300">
                    <div class="lx-category-thumb">
                        <img src="<?php echo e(asset('assets/img/kriminalogiya.jpg')); ?>" alt="" loading="lazy">
                    </div>
                    <div class="lx-category-body">
                        <div class="lx-category-num">04</div>
                        <h3 class="lx-category-title"><?php echo e(__('lan.krimina_ins_jur')); ?></h3>
                    </div>
                    <div class="lx-category-arrow">&rarr;</div>
                </a>
            </div>
    ...
    <section class="lx-section dark lx-stats-bg">
        <div class="container">
            <div class="lx-section-head" data-aos="fade-up">
                ...
                <h2 class="lx-section-title"><?php echo e(__('lan.ins_haq')); ?></h2>
            ...
            <div class="lx-stats-grid">
                <div class="lx-stat" data-aos="fade-up" data-aos-delay="0">
                    ...
                    <div class="lx-stat-number" data-counter="<?php echo e($researchcount); ?>">0</div>
                    <div class="lx-stat-label"><?php echo e(__('lan.maqolalar')); ?></div>
                </div>
                ...
                <div class="lx-stat" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="lx-stat-number" data-counter="<?php echo e($newscount); ?>">0</div>
                    <div class="lx-stat-label"><?php echo e(__('lan.yangilik')); ?></div>
                </div>
                ...
                <div class="lx-stat" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="lx-stat-number" data-counter="<?php echo e($category2PartnersCount); ?>">0</div>
                    <div class="lx-stat-label"><?php echo e(__('lan.xor_ham')); ?></div>
                </div>
                ...
                <div class="lx-stat" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div class="lx-stat-number" data-counter="<?php echo e($category1PartnersCount); ?>">0</div>
                    <div class="lx-stat-label"><?php echo e(__('lan.mah_ham')); ?></div>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="lx-partners-wrap" data-aos="fade-up">
                ...
                <div class="owl-carousel lx-partners-carousel">
                    <?php $__currentLoopData = $lxPartners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e($partner['url']); ?>" target="_blank" rel="noopener" class="lx-partner-card">
                            <div class="lx-partner-logo">
                                <img src="<?php echo e(asset($partner['logo'])); ?>" alt="<?php echo e($partner['name']); ?>" loading="lazy"
                                     onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                <div class="lx-partner-logo-fallback">
                                    <span><?php echo e(strtoupper(substr($partner['name'], 0, 1))); ?></span>
                                </div>
                            </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\user\Desktop\kriminologiya sayt\Kriminalogiya.tar\Kriminalogiya\resources\views\pages\main.blade.php ENDPATH**/ ?>