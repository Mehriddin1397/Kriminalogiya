...
<?php $__currentLoopData = $academia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $academy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="offcanvas offcanvas-end w-50" tabindex="-1" id="tasksDetailsOffcanvasEdit<?php echo e($academy->id); ?>">
        ...
        <div class="offcanvas-body">
            <form action="<?php echo e(route('institut.update', $academy->id)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="row">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <textarea name="description_uz" class="form-control"><?php echo e(old('description_uz',$academy->description_uz)); ?></textarea>
                    </div>
                    <div class="form-group mb-4">
                        <label class="form-label"> Matni(ru):</label>
                        <textarea name="description_ru" class="form-control"><?php echo e(old('description_ru',$academy->description_ru)); ?></textarea>
                    </div>
                    <div class="form-group mb-4">
                        <label class="form-label"> Matni(en):</label>
                        <textarea name="description_en" class="form-control"><?php echo e(old('description_en',$academy->description_en)); ?></textarea>
                    </div>
                    <div class="form-group mb-4">
                        <label class="form-label"> Matni(kr):</label>
                        <textarea name="description_kr" class="form-control"><?php echo e(old('description_kr',$academy->description_kr)); ?></textarea>
                    </div>
...
<?php /**PATH C:\Users\user\Desktop\kriminologiya sayt\Kriminalogiya.tar\Kriminalogiya\resources\views\components\admin\institut\institut-modal-edit.blade.php ENDPATH**/ ?>