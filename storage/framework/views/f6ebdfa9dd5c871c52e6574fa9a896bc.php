...
<?php $__currentLoopData = $academia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $academy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="offcanvas offcanvas-end w-50" tabindex="-1" id="tasksDetailsOffcanvasEdit<?php echo e($academy->id); ?>">
        ...
        <div class="offcanvas-body">
            <form action="<?php echo e(route('contact.update', $academy->id)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="row">
                    <div class="form-group mb-4">
                        ...
                        <input type="text" name="address_uz" value="<?php echo e(old('address_uz',$academy->address_uz)); ?>" class="form-control">
                    </div>
                    <div class="form-group mb-4">
                        <label class="form-label">Address_ru:</label>
                        <input type="text" name="address_ru" value="<?php echo e(old('address_ru',$academy->address_ru)); ?>" class="form-control">
                    </div>
                    <div class="form-group mb-4">
                        <label class="form-label">Address_en:</label>
                        <input type="text" name="address_en" value="<?php echo e(old('address_en',$academy->address_en)); ?>" class="form-control">
                    </div>
                    <div class="form-group mb-4">
                        <label class="form-label">Address_kr:</label>
                        <input type="text" name="address_kr" value="<?php echo e(old('address_kr',$academy->address_kr)); ?>" class="form-control">
                    </div>
                    <div class="form-group mb-4">
...
<?php /**PATH C:\Users\user\Desktop\kriminologiya sayt\Kriminalogiya.tar\Kriminalogiya\resources\views\components\admin\contact\contact-modal-edit.blade.php ENDPATH**/ ?>