...
<?php $__currentLoopData = $academia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $academy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="offcanvas offcanvas-end w-50" tabindex="-1" id="tasksDetailsOffcanvasEdit<?php echo e($academy->id); ?>">
        <div class="offcanvas-header border-bottom" style="padding-top: 20px; padding-bottom: 20px">
            <div class="d-flex align-items-center">
                ...
                <a href="javascript:void(0);">
                    <h2 class="fs-14 fw-bold text-truncate-1-line">Ilmiy salohiyat</h2>
        ...
        <div class="offcanvas-body">
            <form action="<?php echo e(route('expertise.update', $academy->id)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="row">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="text" name="title_uz" value="<?php echo e(old('title_uz',$academy->title_uz)); ?>" class="form-control">
                    </div>
                    <div class="form-group mb-4">
                        <label class="form-label">Title(ru):</label>
                        <input type="text" name="title_ru" value="<?php echo e(old('title_ru',$academy->title_ru)); ?>" class="form-control">
                    </div>
                    <div class="form-group mb-4">
                        <label class="form-label">Title(en):</label>
                        <input type="text" name="title_en" value="<?php echo e(old('title_en',$academy->title_en)); ?>" class="form-control">
                    </div>
                    <div class="form-group mb-4">
                        <label class="form-label">Title(kr):</label>
                        <input type="text" name="title_kr" value="<?php echo e(old('title_kr',$academy->title_kr)); ?>" class="form-control">
                    </div>
                    <div class="form-group mb-4">
                        <label class="form-label"> Matni(uz):</label>
                        <textarea name="description_uz" class="form-control ckeditor"><?php echo e(old('description_uz',$academy->description_uz)); ?></textarea>
                    </div>
                    <div class="form-group mb-4">
                        <label class="form-label"> Matni(ru):</label>
                        <textarea name="description_ru" class="form-control ckeditor"><?php echo e(old('description_ru',$academy->description_ru)); ?></textarea>
                    </div>
                    <div class="form-group mb-4">
                        <label class="form-label"> Matni(en):</label>
                        <textarea name="description_en" class="form-control ckeditor"><?php echo e(old('description_en',$academy->description_en)); ?></textarea>
                    </div>
                    <div class="form-group mb-4">
                        <label class="form-label"> Matni(kr):</label>
                        <textarea name="description_kr" class="form-control ckeditor"><?php echo e(old('description_kr',$academy->description_kr)); ?></textarea>
                    </div>
                            ...
                            <select name="categories[]" class="form-select form-control">
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($category->id); ?>"
                                            <?php if($academy->categories->contains($category->id)): ?> selected <?php endif; ?>><?php echo e($category->name_uz); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                    <div class="form-group mb-4">
                        ...
                        <input type="text" name="youtube_link" value="<?php echo e(old('youtube_link',$academy->youtube_link)); ?>" class="form-control">
                    </div>
                    <div class="form-group mb-4">
                        <label class="form-label">telegram_link:</label>
                        <input type="text" name="telegram_link" value="<?php echo e(old('telegram_link',$academy->telegram_link)); ?>" class="form-control">
                    </div>
                    <div class="form-group mb-4">
                        <label class="form-label">facebook_link:</label>
                        <input type="text" name="facebook_link" value="<?php echo e(old('facebook_link',$academy->facebook_link)); ?>" class="form-control">
                    </div>
                    <div class="form-group mb-4">
                        <label class="form-label">whatsapp_link:</label>
                        <input type="text" name="whatsapp_link" value="<?php echo e(old('whatsapp_link',$academy->whatsapp_link)); ?>" class="form-control">
                    </div>
...
<?php /**PATH C:\Users\user\Desktop\kriminologiya sayt\Kriminalogiya.tar\Kriminalogiya\resources\views\components\admin\expertise\expertise-modal-edit.blade.php ENDPATH**/ ?>