<?php $__env->startSection('title', 'Kitobxonlik'); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="page-header position-fixed">
            <div class="page-header-left d-flex align-items-center">
                <div class="page-header-title">
                    <h5 class="m-b-10">Kitobxonlik</h5>
                </div>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>">Home</a></li>
                    <li class="breadcrumb-item">Kitobxonlik</li>
                </ul>
            </div>
                                        ...
                                        <tr class="single-item">
                                            ...
                                            <td>
                                                <div class="hstack gap-2 justify-content-end">
                                                    ...
                                                    <form action="<?php echo e(route('bibliophilia.destroy', $academy->id)); ?>"
                                                          method="POST">
                                                        <?php echo csrf_field(); ?>
    ...
    <?php echo $__env->make('components.admin.bibliophilia.bibliophilia-modal-create', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('components.admin.bibliophilia.bibliophilia-modal-edit', ['academia' => $academia], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Desktop\kriminologiya sayt\Kriminalogiya.tar\Kriminalogiya\resources\views\admin\bibliophilia\index.blade.php ENDPATH**/ ?>