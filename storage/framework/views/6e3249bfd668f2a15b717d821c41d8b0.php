            ...
            <div class="lx-topbar-right">
                <?php if(isset($contact)): ?>
                    <?php if(!empty($contact->phone)): ?>
                        <a href="tel:<?php echo e(preg_replace('/[^0-9+]/', '', $contact->phone)); ?>" class="lx-topbar-item">
                            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6">
                    ...
                    <?php if(!empty($contact->email)): ?>
                        <a href="mailto:<?php echo e($contact->email); ?>" class="lx-topbar-item">
                            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6">
...
<header class="lx-nav" id="lxNav">
    <div class="container">
        <div class="lx-nav-inner">
            ...
            <a class="lx-nav-brand" href="<?php echo e(route('main')); ?>">
            ...
            <ul class="lx-nav-menu">
                <?php $__currentLoopData = $lxMenu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="lx-nav-item">
                        ...
                        <?php else: ?>
                            <a href="<?php echo e($item['url']); ?>" class="lx-nav-link"><?php echo e($item['title']); ?></a>
                        <?php endif; ?>
                    </li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </ul>
            ...
            <div class="lx-nav-actions">
                <button type="button" class="lx-nav-icon-btn" data-lx="open-search" aria-label="<?php echo e(__('lan.qidirish')); ?>">
                ...
                <div class="lx-nav-lang">
                    <?php $__currentLoopData = $lxLangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('setLocale', $code)); ?>"
                           class="<?php echo e($lxCurrentLang === $code ? 'is-active' : ''); ?>"><?php echo e($label); ?></a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
...
<div class="lx-nav-search-overlay" id="lxSearchOverlay" role="dialog" aria-modal="true" aria-hidden="true">
    ...
    <form action="<?php echo e(route('search')); ?>" method="get">
        <input type="text" name="query" placeholder="<?php echo e(__('lan.qidirish')); ?>..." required autocomplete="off">
        <button type="submit" class="submit" aria-label="<?php echo e(__('lan.qidirish')); ?>">
...
<aside class="lx-drawer" id="lxDrawer" aria-hidden="true">
    <div class="lx-drawer-head">
        <a href="<?php echo e(route('main')); ?>" class="lx-drawer-brand">
    ...
    <div class="lx-drawer-body">
        <div class="lx-drawer-search">
            <form action="<?php echo e(route('search')); ?>" method="get">
                <input type="text" name="query" placeholder="<?php echo e(__('lan.qidirish')); ?>..." required>
                <button type="submit" aria-label="<?php echo e(__('lan.qidirish')); ?>">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7">
                        <circle cx="11" cy="11" r="8"/>
                        <path d="m21 21-4.3-4.3"/>
                    </svg>
...
<?php /**PATH C:\Users\user\Desktop\kriminologiya sayt\Kriminalogiya.tar\Kriminalogiya\resources\views/components/navbar.blade.php ENDPATH**/ ?>