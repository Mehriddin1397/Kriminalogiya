<?php $__env->startSection('title', 'Ilmiy salohiyat'); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="page-header position-fixed">
            <div class="page-header-left d-flex align-items-center">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Ilmiy salohiyat</li>
                </ul>
            </div>
                                        ...
                                        <tr class="single-item">
                                            ...
                                            <td>
                                                <div class="hstack gap-2 justify-content-end">
                                                    ...
                                                    <form action="<?php echo e(route('expertise.destroy', $academy->id)); ?>"
                                                          method="POST">
                                                        <?php echo csrf_field(); ?>
    ...
    <?php echo $__env->make('components.admin.expertise.expertise-modal-create', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('components.admin.expertise.expertise-modal-edit', ['academia' => $academia], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Desktop\kriminologiya sayt\Kriminalogiya.tar\Kriminalogiya\resources\views\admin\expertise\index.blade.php ENDPATH**/ ?>