...
<div class="home-luxury">
    ...
    <section class="lx-page-hero">
        ...
        <div class="container">
            ...
            <h1 class="lx-page-title" data-aos="fade-up"><?php echo e($institut->name); ?></h1>
            <div class="lx-page-divider" data-aos="fade-up"></div>
            <p class="lx-page-meta" data-aos="fade-up">
                <?php echo e($institut->created_at?->format('d.m.Y')); ?>
                    ...
                    <div class="lx-image-frame">
                        <?php
                            ...
                            $aboutImage = collect($aboutImageCandidates)
                                ...
                                ?? 'assets/img/kti-logo.png';
                        ?>
                        <img src="<?php echo e(asset($aboutImage)); ?>" alt="<?php echo e($institut->name); ?>" loading="lazy">
                    </div>

                    <?php if($institut->created_at): ?>
                        <div class="lx-image-badge">
                            <span class="lx-eyebrow">EST.</span>
                            <span class="lx-badge-num"><?php echo e($institut->created_at->format('Y')); ?></span>
                        </div>
                    <?php endif; ?>
                </div>

                <div class="lx-about-text" data-aos="fade-left">
                    <span class="lx-eyebrow"><?php echo e($category->slug); ?></span>
                    <h2 class="lx-section-title"><?php echo e($institut->name); ?></h2>
                    ...
                    <?php if(isset($contact)): ?>
                        <div class="lx-social-strip">
                            <span class="lx-social-strip-label"><?php echo e(__('lan.boglanish') ?? 'Bog\'lanish'); ?></span>
                            <?php if(!empty($contact->telegram_link)): ?>
                                <a href="<?php echo e($contact->telegram_link); ?>" target="_blank" rel="noopener" class="lx-social-link"><i class="fab fa-telegram"></i></a>
                            <?php endif; ?>
                            <?php if(!empty($contact->facebook_link)): ?>
                                <a href="<?php echo e($contact->facebook_link); ?>" target="_blank" rel="noopener" class="lx-social-link"><i class="fab fa-facebook-f"></i></a>
                            <?php endif; ?>
                            <?php if(!empty($contact->whatsapp_link)): ?>
                                <a href="<?php echo e($contact->whatsapp_link); ?>" target="_blank" rel="noopener" class="lx-social-link"><i class="fab fa-whatsapp"></i></a>
                            <?php endif; ?>
                            <?php if(!empty($contact->youtube_link)): ?>
                                <a href="<?php echo e($contact->youtube_link); ?>" target="_blank" rel="noopener" class="lx-social-link"><i class="fab fa-youtube"></i></a>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
                </div>
    ...
    <section class="lx-section dark lx-stats-bg">
        <div class="container">
            <div class="lx-section-head" data-aos="fade-up">
                ...
                <h2 class="lx-section-title"><?php echo e(__('lan.ins_vaz') ?? 'Institut vazifalari'); ?></h2>
    ...
    <section class="lx-quote-section">
        <div class="container">
            <div class="lx-quote" data-aos="fade-up">
                ...
                <div class="lx-quote-author"><?php echo e($institut->name); ?></div>
            </div>
            ...
            <div class="lx-back-wrap" data-aos="fade-up" data-aos-delay="200">
                <a href="<?php echo e(route('main')); ?>" class="lx-btn lx-btn-dark">
                    ...
                    <span><?php echo e(__('lan.ortga')); ?></span>
                </a>
            </div>
        </div>
    </section>
...
<?php endif; ?>
<?php /**PATH C:\Users\user\Desktop\kriminologiya sayt\Kriminalogiya.tar\Kriminalogiya\resources\views/pages/texts.blade.php ENDPATH**/ ?>