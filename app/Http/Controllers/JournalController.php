...
class JournalController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('file_path')) {
            $filePath = $request->file('file_path')->store('journal/files', 'public');
        }

        $academia = Journal::create([
        ...
        if ($request->has('categories')) {
            $academia->categories()->attach($request->categories, ['categorizable_type' => Journal::class]);
        }
        return redirect()->route('journal.index')->with('success', 'Academia muvaffaqiyatli yaratildi.');
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('journal.index')->with('success', 'Academia muvaffaqiyatli yangilandi.');
    }
