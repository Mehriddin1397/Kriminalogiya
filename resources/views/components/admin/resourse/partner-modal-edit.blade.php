...
@foreach($resources as $academy )
    <div class="offcanvas offcanvas-end w-50" tabindex="-1" id="tasksDetailsOffcanvasEdit{{ $academy->id }}">
        ...
        <div class="offcanvas-body">
            <form action="{{ route('resources.update', $academy->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" name="link" value="{{old('link',$academy->link)}}" class="form-control @error('link') is-invalid @enderror" placeholder="https://...">
