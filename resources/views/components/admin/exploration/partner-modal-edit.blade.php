...
@foreach($explorations as $exploration )
    <div class="offcanvas offcanvas-end w-50" tabindex="-1" id="tasksDetailsOffcanvasEdit{{ $exploration->id }}">
        ...
        <div class="offcanvas-body">
            <form action="{{ route('explorations.update', $exploration->id) }}" method="POST">
                ...
                <div class="mb-3">
                    <label>Name KR</label>
                    <input type="text" name="name_kr" class="form-control @error('name_kr') is-invalid @enderror"
                ...
                <div class="mb-3">
                    ...
                    <textarea name="purpose_uz" class="form-control @error('purpose_uz') is-invalid @enderror" rows="4">{{ old('purpose_uz', $exploration->purpose_uz) }}</textarea>
                    @error('purpose_uz')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>

                <div class="mb-3">
                    <label>Maqsadi RU</label>
                    <textarea name="purpose_ru" class="form-control @error('purpose_ru') is-invalid @enderror" rows="4">{{ old('purpose_ru', $exploration->purpose_ru) }}</textarea>
                    @error('purpose_ru')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>

                <div class="mb-3">
                    <label>Maqsadi EN</label>
                    <textarea name="purpose_en" class="form-control @error('purpose_en') is-invalid @enderror" rows="4">{{ old('purpose_en', $exploration->purpose_en) }}</textarea>
                    @error('purpose_en')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>

                <div class="mb-3">
                    <label>Maqsadi KR</label>
                    <textarea name="purpose_kr" class="form-control @error('purpose_kr') is-invalid @enderror" rows="4">{{ old('purpose_kr', $exploration->purpose_kr) }}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="tasks_uz" class="form-control @error('tasks_uz') is-invalid @enderror" rows="4">{{ old('tasks_uz', $exploration->tasks_uz) }}</textarea>
                    @error('tasks_uz')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>

                <div class="mb-3">
                    <label>Vazifalari RU</label>
                    <textarea name="tasks_ru" class="form-control @error('tasks_ru') is-invalid @enderror" rows="4">{{ old('tasks_ru', $exploration->tasks_ru) }}</textarea>
                    @error('tasks_ru')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>

                <div class="mb-3">
                    <label>Vazifalari EN</label>
                    <textarea name="tasks_en" class="form-control @error('tasks_en') is-invalid @enderror" rows="4">{{ old('tasks_en', $exploration->tasks_en) }}</textarea>
                    @error('tasks_en')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>

                <div class="mb-3">
                    <label>Vazifalari KR</label>
                    <textarea name="tasks_kr" class="form-control @error('tasks_kr') is-invalid @enderror" rows="4">{{ old('tasks_kr', $exploration->tasks_kr) }}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="expected_results_uz" class="form-control @error('expected_results_uz') is-invalid @enderror" rows="4">{{ old('expected_results_uz', $exploration->expected_results_uz) }}</textarea>
                    @error('expected_results_uz')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>

                <div class="mb-3">
                    <label>Kutilayotgan natijalar RU</label>
                    <textarea name="expected_results_ru" class="form-control @error('expected_results_ru') is-invalid @enderror" rows="4">{{ old('expected_results_ru', $exploration->expected_results_ru) }}</textarea>
                    @error('expected_results_ru')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>

                <div class="mb-3">
                    <label>Kutilayotgan natijalar EN</label>
                    <textarea name="expected_results_en" class="form-control @error('expected_results_en') is-invalid @enderror" rows="4">{{ old('expected_results_en', $exploration->expected_results_en) }}</textarea>
                    @error('expected_results_en')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>

                <div class="mb-3">
                    <label>Kutilayotgan natijalar KR</label>
                    <textarea name="expected_results_kr" class="form-control @error('expected_results_kr') is-invalid @enderror" rows="4">{{ old('expected_results_kr', $exploration->expected_results_kr) }}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="leader_uz" class="form-control @error('leader_uz') is-invalid @enderror"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="leader_ru" class="form-control @error('leader_ru') is-invalid @enderror"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="leader_en" class="form-control @error('leader_en') is-invalid @enderror"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="leader_kr" class="form-control @error('leader_kr') is-invalid @enderror"
                        ...
                        <select name="categories[]" class="form-select form-control @error('categories') is-invalid @enderror">
                            @foreach($categories as $category)
                                <option value="{{ $category->id }}"
                                        @if($exploration->categories->contains($category->id)) selected @endif>{{ $category->name_uz }}</option>
                            @endforeach
                        </select>
