            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input type="text" name="country_uz" value="{{ old('country_uz') }}" class="form-control @error('country_uz') is-invalid @enderror">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input type="text" name="country_ru" value="{{ old('country_ru') }}" class="form-control @error('country_ru') is-invalid @enderror">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input type="text" name="country_en" value="{{ old('country_en') }}" class="form-control @error('country_en') is-invalid @enderror">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input type="text" name="country_kr" value="{{ old('country_kr') }}" class="form-control @error('country_kr') is-invalid @enderror">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input type="text" name="org_uz" value="{{ old('org_uz') }}" class="form-control @error('org_uz') is-invalid @enderror">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input type="text" name="org_ru" value="{{ old('org_ru') }}" class="form-control @error('org_ru') is-invalid @enderror">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input type="text" name="org_en" value="{{ old('org_en') }}" class="form-control @error('org_en') is-invalid @enderror">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input type="text" name="org_kr" value="{{ old('org_kr') }}" class="form-control @error('org_kr') is-invalid @enderror">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <select name="flag" class="form-select form-control @error('flag') is-invalid @enderror">
                            @foreach(['uz'=>'O‘zbekiston','hu'=>'Vengriya','in'=>'Hindiston','kr'=>'Janubiy Koreya','intl'=>'Xalqaro','qa'=>'Qatar','tr'=>'Turkiya','de'=>'Germaniya','ru'=>'Rossiya','by'=>'Belarus','cn'=>'Xitoy','tj'=>'Tojikiston','un'=>'BMT'] as $code => $label)
                                <option value="{{ $code }}" {{ old('flag') === $code ? 'selected' : '' }}>{{ $label }} ({{ $code }})</option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <select name="doc_type" class="form-select form-control @error('doc_type') is-invalid @enderror">
                            <option value="memorandum" {{ old('doc_type') === 'memorandum' ? 'selected' : '' }}>Memorandum</option>
                            <option value="protocol" {{ old('doc_type') === 'protocol' ? 'selected' : '' }}>Bayonnoma (Protokol)</option>
                            <option value="protocol_program" {{ old('doc_type') === 'protocol_program' ? 'selected' : '' }}>Bayonnoma (Dastur)</option>
                        </select>
                ...
                <div class="col-md-12">
                    <div class="form-group mb-4">
                        <label class="form-label">Rasmlari (bosilganda modalda chiqadi):</label>
