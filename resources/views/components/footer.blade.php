    ...
    <div class="container py-5">
        <div class="row g-5">
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <a class="btn btn-link" href="">Kitoblar</a>
                <a class="btn btn-link" href="">Xorijiy yangiliklar</a>
                <a class="btn btn-link" href="">Mahalliy yangiliklar</a>
                <a class="btn btn-link" href="">Tadqiqotchilar</a>
            </div>
            <div class="col-lg-4 col-md-6">
        ...
        <div class="copyright">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="border-bottom" href="#">Kriminalogiya</a>, Barcha huquqlar himoyalangan.
                </div>
                <div class="col-md-6 text-center text-md-end">
                    <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
                    Designed By <a class="border-bottom" href="https://htmlcodex.com">Mehriddin Soyibov</a>
                </div>
            </div>
        </div>
    </div>
