...
@section('content')
        ...
        <div class="page-header position-fixed">
            <div class="page-header-left d-flex align-items-center">
                <div class="page-header-title">
                    <h5 class="m-b-10">Videolar</h5>
                </div>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a></li>
                    <li class="breadcrumb-item">Videolar</li>
                </ul>
            </div>
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table table-hover" id="proposalList">
                                    ...
                                    <tr>
                                        <th>#</th>
                                        <th>Rasm (thumbnail)</th>
                                        <th>Nomi</th>
                                        <th>YouTube havolasi</th>
                                            ...
                                            <td>
                                                <div class="hstack gap-2 justify-content-end">
                                                    <a href="javascript:void(0)" data-bs-toggle="offcanvas"
                                                       data-bs-target="#tasksDetailsOffcanvasEdit{{ $video->id }}"
    ...
    @include('components.admin.videos.videos-modal-create')
    @include('components.admin.videos.videos-modal-edit', ['videos' => $videos])
