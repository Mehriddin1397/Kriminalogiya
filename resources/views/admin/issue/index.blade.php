...
@section('content')
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table table-hover" id="proposalList">
                                    ...
                                    <tbody>
                                    @foreach($issues as $index => $academy)
                                        <tr class="single-item">
                                            ...
                                            <td>
                                                <div class="hstack gap-2 justify-content-end">
                                                    ...
                                                    <form action="{{ route('issues.destroy', $academy->id) }}"
                                                          method="POST">
                                                        @csrf
                                                        @method('DELETE')
    ...
    @include('components.admin.issue.partner-modal-create')
    @include('components.admin.issue.partner-modal-edit')
