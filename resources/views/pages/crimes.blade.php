@php
    ...
    $pdfStaticUrl = route('document.view', ['type' => $category->object_type, 'id' => $research->id]);
@endphp
    ...
    <div class="home-luxury">
        ...
        <section class="lx-section" style="background: var(--lx-cream);">
            <div class="container">
                ...
                <div class="lx-pdf-viewer" data-aos="fade-up" data-lx-pdf data-pdf-src="{{ $pdfStaticUrl }}"
                    ...
                    <div class="lx-pdf-toolbar">
                        ...
                        <div class="lx-pdf-toolbar-center">
                            <button type="button" class="lx-pdf-btn" data-lx-pdf="prev"
                                aria-label="{{ __('Oldingi') }}">
                            ...
                            <span class="lx-pdf-page-info">
                                <input type="number" class="lx-pdf-page-input" data-lx-pdf="page-input" min="1"
                                    value="1">
                                <span class="lx-pdf-page-sep">/</span>
                                <span class="lx-pdf-page-total" data-lx-pdf="page-total">—</span>
                            </span>
                            <button type="button" class="lx-pdf-btn" data-lx-pdf="next"
                                aria-label="{{ __('Keyingi') }}">
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <div class="lx-pdf-toolbar-right">
                            <button type="button" class="lx-pdf-btn" data-lx-pdf="zoom-out"
                                aria-label="{{ __('Kichraytirish') }}">
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <button type="button" class="lx-pdf-btn" data-lx-pdf="zoom-in"
                                aria-label="{{ __('Kattalashtirish') }}">
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    <circle cx="11" cy="11" r="8" />
                            ...
                            <button type="button" class="lx-pdf-btn lx-pdf-btn-fs" data-lx-pdf="fullscreen"
                                aria-label="{{ __("To'liq ekran") }}">
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
